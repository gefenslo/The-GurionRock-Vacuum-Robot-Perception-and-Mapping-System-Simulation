...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        messageBus.addMessage(this, type, callback);
    ...
    private void setDown(Object object){
        if(object instanceof Camera){
           ((Camera)object).setStatus(STATUS.DOWN);
        }
        else if(object instanceof LiDarWorkerTracker){
            ((LiDarWorkerTracker)object).setStatus(STATUS.DOWN);
        }
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                if(message!=null){
                    ConcurrentHashMap<Class<? extends Message>, Callback> map = messageBus.getSubscriptions().get(this);
